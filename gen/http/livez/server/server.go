...
// Server lists the livez service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Livez  http.Handler
}
...
// New instantiates HTTP handlers for all the livez service endpoints using the
...
func (s *Server) Service() string { return "livez" }
...
func (s *Server) MethodNames() []string { return livez.MethodNames[:] }

// Mount configures the mux to serve the livez endpoints.
...
// MountLivezHandler configures the mux to serve the "livez" service "livez"
// endpoint.
...
// calls the "livez" service "livez" endpoint.
func NewLivezHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "livez")
		var err error
